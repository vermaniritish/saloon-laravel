        ...
        <thead class="thead-light">
            <tr>
                ...
                <th class="sort" width="22.5%">
                    Product Title
                    <?php if(isset($_GET['sort']) && $_GET['sort'] == 'order_products.title' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
                    <i class="fas fa-sort-down active" data-field="order_products.title" data-sort="asc"></i>
                    <?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'order_products.title' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
                    <i class="fas fa-sort-up active" data-field="order_products.title" data-sort="desc"></i>
                    <?php else: ?>
                    <i class="fas fa-sort" data-field="order_products.title"></i>
                    <?php endif; ?>
                </th>
                <th class="sort" width="22.5%">
                    Quantity
