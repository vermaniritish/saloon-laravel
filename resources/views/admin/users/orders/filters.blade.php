<div class="dropdown filter-dropdown">
	...
	<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
        <form action="<?php echo route('admin.users.view',['id' => $id]) ?>" method="GET" id="filters-form">
			...
			<a href="<?php echo route('admin.users.view',['id' => $id]) ?>" class="btn btn-sm py-2 px-3 float-left">
				Reset All
			</a>
